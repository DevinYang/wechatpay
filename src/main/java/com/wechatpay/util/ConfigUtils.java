...
public class ConfigUtils {
	...
	public static final String QUERY_URL = GetPropertiesValue.getValue(configUrl, "common_query_interface");
	public static final String TRANSACTION_ID = GetPropertiesValue.getValue(configUrl, "transaction_id");
	public static final String OUT_TRADE_NO = GetPropertiesValue.getValue(configUrl, "out_trade_no");
}
